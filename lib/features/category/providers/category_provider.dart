...
class CategoryProvider extends ChangeNotifier {
  ...
  void getCategoryProductList(int? categoryID, {int? brandID}) async {
    ...
    notifyListeners();
    ApiResponseModel apiResponse = await categoryRepo.getCategoryProductList(categoryID.toString(), addBrandID);
  ...
  Future<ApiResponseModel?> getBrandList(bool reload, int categoryID,) async { 
    _brandList = null;
    ApiResponseModel? apiResponse;
